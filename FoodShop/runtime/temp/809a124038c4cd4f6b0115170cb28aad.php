<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpStudy\PHPTutorial\WWW\foodshop\public/../application/admin\view\cfood\cmtclassify.html";i:1647874771;s:75:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\top.html";i:1648311974;s:76:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\left.html";i:1648388244;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div class="widget-buttons">
                    <div class="btn-group ">
                        ...
                        <ul class="dropdown-menu dropdown-blue pull-left">
                            <li>
                                <a href="cmtclassify?id=1">点心/蛋糕</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=2">饼干膨化</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=3">熟食肉类</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=4">素食卤味</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=5">海鲜、河鲜</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=6">花茶、奶茶</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=7">家常小菜</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=8">快餐简食</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="cmtclassify?id=9">蔬菜水果</a>
                            </li>
                        </ul>
                    </div>
                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\foodshop\public/../application/admin\view\cfood\lst.html";i:1647875200;s:75:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\top.html";i:1648311974;s:76:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\left.html";i:1648388244;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="餐品列表" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="widget-buttons">
                    <div class="btn-group ">
                        <a class="btn btn-azure btn-sm " href="javascript:void(0);">筛选食品</a>
                        ...
                        <ul class="dropdown-menu dropdown-blue pull-left">
                            <li>
                                <a href="classify?id=1">点心/蛋糕</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=2">饼干膨化</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=3">熟食肉类</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=4">素食卤味</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=5">海鲜、河鲜</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=6">花茶、奶茶</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=7">家常小菜</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=8">快餐简食</a>
                            </li><li class="divider"></li>
                            <li>
                                <a href="classify?id=9">蔬菜水果</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" class="col-sm-4">
                                                ...
                                                <a  href="setcomment?id=<?php echo $row['id']; ?>"
                                                    class="btn btn-success btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 置为推荐
                                                </a>
                                                <a  href="setdiscount?id=<?php echo $row['id']; ?>"
                                                    class="btn btn-yellow btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 置为优惠
                                                </a>
                                            </td>
                                        </tr>

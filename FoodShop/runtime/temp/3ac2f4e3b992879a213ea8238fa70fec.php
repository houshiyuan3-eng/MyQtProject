<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\phpStudy\PHPTutorial\WWW\foodshop\public/../application/admin\view\sendfood\lst.html";i:1648392108;s:75:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\top.html";i:1648311974;s:76:"D:\phpStudy\PHPTutorial\WWW\foodshop\application\admin\view\public\left.html";i:1648388244;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div style="width: 250px; height: 30px;">
    <form action="<?php echo url('sendfood/lst'); ?>" method="post">
    <input type="text" name="name" style="width: 160px; height: 30px;float: left">
    <input type="submit" value="搜索" style="width: 50px; height: 30px;float: left;text-align: center;border: none">
    </form>
</div>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <?php if($row['finish'] == 0): ?>
                                <a  href="" onClick="warning('确实签收吗？', 'assure?id=<?php echo $row['id']; ?>')"
